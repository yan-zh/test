...
public class PaperController {
    ...
    @RequestMapping(value = "/author/paperAddDB", method =  RequestMethod.POST)
    public Object insertPaperDB(@RequestBody PaperAddDto paperAddDto){
...
//        String paperDetail =  request.getParameter("paperDetail").trim();
    ...
    @PostMapping(value = "/author/paperAdd")
    public Object insertPaper(MultipartFile mpFile) {
        JSONObject jsonObject = new JSONObject();
        //Upload Paper File
        if (mpFile.isEmpty()) {
            jsonObject.put("code", 0);
        ...
        jsonObject.put("code", 400);
        jsonObject.put("paper", filePath + System.getProperty("file.separator") + fileName);
